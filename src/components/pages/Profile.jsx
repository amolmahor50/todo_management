                ...
                <form className="grid gap-6 mt-6">
                    ...
                    <div className="grid sm:grid-cols-2">
                        <div className="grid gap-2">
                            ...
                            <textarea name="address" placeholder="Address" rows={3} value={formData.address} onChange={handleChange} className="p-3 rounded-md shadow-sm outline-none focus:border-orange-400 border-2 dark:text-black" />
                        </div>
                    </div>
